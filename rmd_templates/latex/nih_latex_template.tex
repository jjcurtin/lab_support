...
%%%%%%%%%%
% personal preamble edits here this is from https://github.com/tgerke/nih-rmd-template
...
\def\@seccntformat#1{%
  ...
  \@startsection{section}{1}{\z@}
    {10pt \@plus 0pt \@minus 0pt}
    {.01pt \@plus 0pt }%reduce space below subsection (was 1.5ex)
    {\normalfont\normalsize\bf\centering}} %modify font style
  ...
  \@startsection{subsubsection}{3}{\z@}
    {0pt \@plus 0pt \@minus 0pt} %reduce space above subsubsection (was -3.25ex)
