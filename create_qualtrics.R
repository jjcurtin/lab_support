create_qualtrics <- function(subid,
                             survey_name,
                             api_token,
                             root_url = "https://uwmadison.co1.qualtrics.com",
                             encode = "json") {
  # create_qualtrics() creates a new qualtrics survey. It returns the surveyID
  ...
  # NOTE: based on John Curtin's simplification of Jasper Ginn's qualtRics package.  
  ...
  } else if (survey_name == "feedback") {
    survey_name <- "Daily Recovery Feedback"
  }
