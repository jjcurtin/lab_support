...
- Add the following files at the root of your repo (download from my `lab_support` repo)
  - [demo_slides.qmd]()
  - [presentation.css]()
  - [publish.sh]()
 
- Add the following files to your `figs` folder for my demo to work (download from my lab_support repo)
  - [fig.R]() 
