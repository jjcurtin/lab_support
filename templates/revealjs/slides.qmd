...
Source the script and then display the plot object

Good for reusable plot code.  

I use this approach for my presentations

I also do side by side text and plot a lot
::::
...
It would typically be put in a fragment to have it appear incrementally

The class that supports this is in our css file (presentation.css)
