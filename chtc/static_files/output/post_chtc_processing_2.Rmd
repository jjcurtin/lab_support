...
```{r}
jobs <- vroom::vroom(here(path_jobs, name_job, "input/jobs.csv"), col_types = vroom::cols())
...
for (i in feature_sets) {
  ...
  if (nrow(subset(results_i, algorithm == "glmnet")) != 0){
    ...
    print(str_c("Plotting glmnet hyperparameters for ", i, " feature set"))
  ...
  if (nrow(subset(results_i, algorithm == "random_forest")) != 0) {
    ...
    print(str_c("Plotting random forest hyperparameters for ", i, " feature set"))
  ...
  if (nrow(subset(results_i, algorithm == "knn")) != 0) {
    ...
    print(str_c("Plotting knn hyperparameters for ", i, " feature set"))
